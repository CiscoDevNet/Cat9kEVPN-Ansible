# LAYER3 LOOP (L3_LOOP) USE CASE #1
...
### Main playbook execution example:
  ...
  * **The main playbook execution should look like this**:
    ...
    ok: [sw-access-leaf-2] => (item={'vrf_name': 'VRF_OVERLAY_2030', 'vrf_core_vlan_id': 2030, 'vrf_l3_vni_id': 20030, 'vrf_edge_vlan': [{'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'}]})
    ...
    TASK [layer_3_loop : include_tasks] ******************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2

    TASK [layer_3_loop : include_tasks] ******************************************************************
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4_inner_loop.yml for sw-access-leaf-1 => (item={'vrf_name': 'VRF_OVERLAY_2010', 'vrf_core_vlan_id': 2010, 'vrf_l3_vni_id': 20010, 'vrf_edge_vlan': [{'id': 10, 'ip': '10.10.10.1', 'mask': '255.255.255.0'}, {'id': 20, 'ip': '10.20.20.1', 'mask': '255.255.255.0'}, {'id': 30, 'ip': '10.30.30.1', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4_inner_loop.yml for sw-access-leaf-1 => (item={'vrf_name': 'VRF_OVERLAY_2020', 'vrf_core_vlan_id': 2020, 'vrf_l3_vni_id': 20020, 'vrf_edge_vlan': [{'id': 40, 'ip': '10.40.40.1', 'mask': '255.255.255.0'}, {'id': 50, 'ip': '10.50.50.1', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4_inner_loop.yml for sw-access-leaf-1 => (item={'vrf_name': 'VRF_OVERLAY_2030', 'vrf_core_vlan_id': 2030, 'vrf_l3_vni_id': 20030, 'vrf_edge_vlan': [{'id': 60, 'ip': '10.60.60.1', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4_inner_loop.yml for sw-access-leaf-2 => (item={'vrf_name': 'VRF_OVERLAY_2010', 'vrf_core_vlan_id': 2010, 'vrf_l3_vni_id': 20010, 'vrf_edge_vlan': [{'id': 10, 'ip': '10.10.10.2', 'mask': '255.255.255.0'}, {'id': 20, 'ip': '10.20.20.2', 'mask': '255.255.255.0'}, {'id': 30, 'ip': '10.30.30.2', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4_inner_loop.yml for sw-access-leaf-2 => (item={'vrf_name': 'VRF_OVERLAY_2020', 'vrf_core_vlan_id': 2020, 'vrf_l3_vni_id': 20020, 'vrf_edge_vlan': [{'id': 40, 'ip': '10.40.40.2', 'mask': '255.255.255.0'}, {'id': 50, 'ip': '10.50.50.2', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/l3_edge_vlan_ipv4_inner_loop.yml for sw-access-leaf-2 => (item={'vrf_name': 'VRF_OVERLAY_2030', 'vrf_core_vlan_id': 2030, 'vrf_l3_vni_id': 20030, 'vrf_edge_vlan': [{'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'}]})

    TASK [layer_3_loop : CONFIG L2 EDGE VLAN] ************************************************************
    changed: [sw-access-leaf-1] => (item={'id': 10, 'ip': '10.10.10.1', 'mask': '255.255.255.0'})
    changed: [sw-access-leaf-1] => (item={'id': 20, 'ip': '10.20.20.1', 'mask': '255.255.255.0'})
    changed: [sw-access-leaf-1] => (item={'id': 30, 'ip': '10.30.30.1', 'mask': '255.255.255.0'})
    ...
    ok: [sw-access-leaf-1] => (item={'changed': False, 'stdout': ['vlan 20\n name 20\nvlan 2010\n name 2010\nvlan 2020\n name 2020\nvlan 2030\n name 2030\n switchport access vlan 20\n switchport access vlan 20\n switchport access vlan 20\n switchport access vlan 20', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan20\n description VLAN20 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2010\n ip dhcp relay information option vpn-id \n ip address 10.20.20.1 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 20', ' name 20', 'vlan 2010', ' name 2010', 'vlan 2020', ' name 2020', 'vlan 2030', ' name 2030', ' switchport access vlan 20', ' switchport access vlan 20', ' switchport access vlan 20', ' switchport access vlan 20'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan20', ' description VLAN20 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2010', ' ip dhcp relay information option vpn-id ', ' ip address 10.20.20.1 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 20', 'show running-config interface Vlan20'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 20, 'ip': '10.20.20.1', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 20",
    ...
    TASK [layer_3_loop : CONFIG L2 EDGE VLAN] ************************************************************
    changed: [sw-access-leaf-1] => (item={'id': 40, 'ip': '10.40.40.1', 'mask': '255.255.255.0'})
    changed: [sw-access-leaf-1] => (item={'id': 50, 'ip': '10.50.50.1', 'mask': '255.255.255.0'})
    ...
    TASK [layer_3_loop : CONFIG L2 EDGE VLAN] ************************************************************
    changed: [sw-access-leaf-2] => (item={'id': 10, 'ip': '10.10.10.2', 'mask': '255.255.255.0'})
    changed: [sw-access-leaf-2] => (item={'id': 20, 'ip': '10.20.20.2', 'mask': '255.255.255.0'})
    changed: [sw-access-leaf-2] => (item={'id': 30, 'ip': '10.30.30.2', 'mask': '255.255.255.0'})
    ...
    TASK [layer_3_loop : SHOW CONFIG] ********************************************************************
    ok: [sw-access-leaf-2] => (item={'id': 10, 'ip': '10.10.10.2', 'mask': '255.255.255.0'})
    ok: [sw-access-leaf-2] => (item={'id': 20, 'ip': '10.20.20.2', 'mask': '255.255.255.0'})
    ok: [sw-access-leaf-2] => (item={'id': 30, 'ip': '10.30.30.2', 'mask': '255.255.255.0'})

    TASK [layer_3_loop : DEBUG] **************************************************************************
    ok: [sw-access-leaf-2] => (item={'changed': False, 'stdout': ['vlan 10\n name 10\n switchport trunk allowed vlan 10,20,30', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan10\n description VLAN10 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2010\n ip dhcp relay information option vpn-id \n ip address 10.10.10.2 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 10', ' name 10', ' switchport trunk allowed vlan 10,20,30'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan10', ' description VLAN10 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2010', ' ip dhcp relay information option vpn-id ', ' ip address 10.10.10.2 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 10', 'show running-config interface Vlan10'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 10, 'ip': '10.10.10.2', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 10",
    ...
    ok: [sw-access-leaf-2] => (item={'changed': False, 'stdout': ['vlan 20\n name 20\nvlan 2010\n name 2010\nvlan 2020\n name 2020\nvlan 2030\n name 2030\n switchport trunk allowed vlan 20,40\n switchport trunk allowed vlan 20,40', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan20\n description VLAN20 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2010\n ip dhcp relay information option vpn-id \n ip address 10.20.20.2 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 20', ' name 20', 'vlan 2010', ' name 2010', 'vlan 2020', ' name 2020', 'vlan 2030', ' name 2030', ' switchport trunk allowed vlan 20,40', ' switchport trunk allowed vlan 20,40'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan20', ' description VLAN20 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2010', ' ip dhcp relay information option vpn-id ', ' ip address 10.20.20.2 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 20', 'show running-config interface Vlan20'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 20, 'ip': '10.20.20.2', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 20",
    ...
    ok: [sw-access-leaf-2] => (item={'changed': False, 'stdout': ['vlan 30\n name 30', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan30\n description VLAN30 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2010\n ip dhcp relay information option vpn-id \n ip address 10.30.30.2 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 30', ' name 30'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan30', ' description VLAN30 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2010', ' ip dhcp relay information option vpn-id ', ' ip address 10.30.30.2 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 30', 'show running-config interface Vlan30'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 30, 'ip': '10.30.30.2', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 30",
    ...
    TASK [layer_3_loop : CONFIG L2 EDGE VLAN] ************************************************************
    changed: [sw-access-leaf-2] => (item={'id': 40, 'ip': '10.40.40.2', 'mask': '255.255.255.0'})
    changed: [sw-access-leaf-2] => (item={'id': 50, 'ip': '10.50.50.2', 'mask': '255.255.255.0'})
    ...
    TASK [layer_3_loop : SHOW CONFIG] ********************************************************************
    ok: [sw-access-leaf-2] => (item={'id': 40, 'ip': '10.40.40.2', 'mask': '255.255.255.0'})
    ok: [sw-access-leaf-2] => (item={'id': 50, 'ip': '10.50.50.2', 'mask': '255.255.255.0'})

    TASK [layer_3_loop : DEBUG] **************************************************************************
    ok: [sw-access-leaf-2] => (item={'changed': False, 'stdout': ['vlan 40\n name 40', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan40\n description VLAN40 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2020\n ip dhcp relay information option vpn-id \n ip address 10.40.40.2 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 40', ' name 40'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan40', ' description VLAN40 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2020', ' ip dhcp relay information option vpn-id ', ' ip address 10.40.40.2 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 40', 'show running-config interface Vlan40'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 40, 'ip': '10.40.40.2', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 40",
    ...
    ok: [sw-access-leaf-2] => (item={'changed': False, 'stdout': ['vlan 50\n name 50', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan50\n description VLAN50 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2020\n ip dhcp relay information option vpn-id \n ip address 10.50.50.2 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 50', ' name 50'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan50', ' description VLAN50 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2020', ' ip dhcp relay information option vpn-id ', ' ip address 10.50.50.2 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 50', 'show running-config interface Vlan50'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 50, 'ip': '10.50.50.2', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 50",
    ...
    TASK [layer_3_loop : CONFIG L2 EDGE VLAN] ************************************************************
    changed: [sw-access-leaf-2] => (item={'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'})

    TASK [layer_3_loop : CONFIG L3 SVI INTERFACE EDGE VLAN] **********************************************
    changed: [sw-access-leaf-2] => (item={'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'})

    TASK [layer_3_loop : SHOW CONFIG] ********************************************************************
    ok: [sw-access-leaf-2] => (item={'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'})

    TASK [layer_3_loop : DEBUG] **************************************************************************
    ok: [sw-access-leaf-2] => (item={'changed': False, 'stdout': ['vlan 60\n name 60', 'Building configuration...\n\nCurrent configuration : 208 bytes\n!\ninterface Vlan60\n description VLAN60 SVI-INTERFACE\n vrf forwarding VRF_OVERLAY_2030\n ip dhcp relay information option vpn-id \n ip address 10.60.60.2 255.255.255.0\n ip helper-address global 10.10.10.10\nend'], 'stdout_lines': [['vlan 60', ' name 60'], ['Building configuration...', '', 'Current configuration : 208 bytes', '!', 'interface Vlan60', ' description VLAN60 SVI-INTERFACE', ' vrf forwarding VRF_OVERLAY_2030', ' ip dhcp relay information option vpn-id ', ' ip address 10.60.60.2 255.255.255.0', ' ip helper-address global 10.10.10.10', 'end']], 'invocation': {'module_args': {'commands': ['show running-config | section vlan 60', 'show running-config interface Vlan60'], 'match': 'all', 'retries': 10, 'interval': 1, 'wait_for': None, 'provider': None}}, 'failed': False, 'item': {'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'}, 'ansible_loop_var': 'item'}) => {
        "msg": [
            [
                [
                    "vlan 60",
    ...
    TASK [layer_3_loop : include_tasks] ******************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/dhcp_config.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3_loop : include_tasks] ******************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/nve_interface.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3_loop : include_tasks] ******************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/bgp_config_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/leaf_border_handoff.yml for sw-access-leaf-2

    TASK [layer_3_loop : CLEAR CONFIG BGP LEAF BORDER HANDOFF] *******************************************
    changed: [sw-access-leaf-2]

    TASK [layer_3_loop : CONFIG BGP LEAF BORDER HANDOFF] *************************************************
    changed: [sw-access-leaf-2] => (item=sw-core-spine-1)

    TASK [layer_3_loop : CONFIG BGP LEAF BORDER HANDOFF VRF] *********************************************
    changed: [sw-access-leaf-2] => (item={'vrf_name': 'VRF_OVERLAY_2010', 'vrf_core_vlan_id': 2010, 'vrf_l3_vni_id': 20010, 'vrf_edge_vlan': [{'id': 10, 'ip': '10.10.10.2', 'mask': '255.255.255.0'}, {'id': 20, 'ip': '10.20.20.2', 'mask': '255.255.255.0'}, {'id': 30, 'ip': '10.30.30.2', 'mask': '255.255.255.0'}]})
    changed: [sw-access-leaf-2] => (item={'vrf_name': 'VRF_OVERLAY_2020', 'vrf_core_vlan_id': 2020, 'vrf_l3_vni_id': 20020, 'vrf_edge_vlan': [{'id': 40, 'ip': '10.40.40.2', 'mask': '255.255.255.0'}, {'id': 50, 'ip': '10.50.50.2', 'mask': '255.255.255.0'}]})
    changed: [sw-access-leaf-2] => (item={'vrf_name': 'VRF_OVERLAY_2030', 'vrf_core_vlan_id': 2030, 'vrf_l3_vni_id': 20030, 'vrf_edge_vlan': [{'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'}]})
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-access-leaf-2]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/layer_3_loop/tasks/use_case_1/spine_bgp_ipv4_core.yml for sw-core-spine-1
    ...
    ok: [sw-access-leaf-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-1_config.2022-02-16@17:55:39",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-1_config.2022-02-16@17:55:39",
                "shortname": "./backup/sw-access-leaf-1_config",
                "time": "17:55:39"
            }
        ]
    ...
    ok: [sw-access-leaf-2] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-2_config.2022-02-16@17:55:39",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-2_config.2022-02-16@17:55:39",
                "shortname": "./backup/sw-access-leaf-2_config",
                "time": "17:55:39"
            }
        ]
    ...
    ok: [sw-core-spine-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-core-spine-1_config.2022-02-16@17:55:39",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-core-spine-1_config.2022-02-16@17:55:39",
                "shortname": "./backup/sw-core-spine-1_config",
                "time": "17:55:39"
            }
        ]
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-access-leaf-2]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/roles/common/tasks/verification_bgp.yml for sw-core-spine-1
        ...
        "msg": [
            {
                ...
                "failed": false,
                "stdout": [
                    "Neighbor        V           AS MsgRcvd MsgSent   TblVer  InQ OutQ Up/Down  State/PfxRcd\n10.255.255.252  4        64512       2       2        1    0    0 00:00:04        0\n10.255.255.253  4        64512       2       2        1    0    0 00:00:13        0"
                ],
                "stdout_lines": [
                    [
                        "Neighbor        V           AS MsgRcvd MsgSent   TblVer  InQ OutQ Up/Down  State/PfxRcd",
    ...
    TASK [layer_3_loop : ASSERT SUCCESS OR FAILURE BASED ON BGP OUTPUT: UPTIME > 00:00:00 AND NEIGHBOORS LEAFS LISTED CORRECTLY] ***
    ok: [sw-core-spine-1] => (item=sw-access-leaf-1) => {
        "ansible_loop_var": "item",
        "changed": false,
        "item": "sw-access-leaf-1",
...
### Utility playbook execution example:
  ...
  * **The utility playbook execution should look like this**:
    ...
    TASK [CLEAR L3/L2 EDGE VLAN IPV4] ********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/playbook_clear_all_config_inner_loop.yml for sw-access-leaf-1 => (item={'vrf_name': 'VRF_OVERLAY_2010', 'vrf_core_vlan_id': 2010, 'vrf_l3_vni_id': 20010, 'vrf_edge_vlan': [{'id': 10, 'ip': '10.10.10.1', 'mask': '255.255.255.0'}, {'id': 20, 'ip': '10.20.20.1', 'mask': '255.255.255.0'}, {'id': 30, 'ip': '10.30.30.1', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/playbook_clear_all_config_inner_loop.yml for sw-access-leaf-1 => (item={'vrf_name': 'VRF_OVERLAY_2020', 'vrf_core_vlan_id': 2020, 'vrf_l3_vni_id': 20020, 'vrf_edge_vlan': [{'id': 40, 'ip': '10.40.40.1', 'mask': '255.255.255.0'}, {'id': 50, 'ip': '10.50.50.1', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/playbook_clear_all_config_inner_loop.yml for sw-access-leaf-1 => (item={'vrf_name': 'VRF_OVERLAY_2030', 'vrf_core_vlan_id': 2030, 'vrf_l3_vni_id': 20030, 'vrf_edge_vlan': [{'id': 60, 'ip': '10.60.60.1', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/playbook_clear_all_config_inner_loop.yml for sw-access-leaf-2 => (item={'vrf_name': 'VRF_OVERLAY_2010', 'vrf_core_vlan_id': 2010, 'vrf_l3_vni_id': 20010, 'vrf_edge_vlan': [{'id': 10, 'ip': '10.10.10.2', 'mask': '255.255.255.0'}, {'id': 20, 'ip': '10.20.20.2', 'mask': '255.255.255.0'}, {'id': 30, 'ip': '10.30.30.2', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/playbook_clear_all_config_inner_loop.yml for sw-access-leaf-2 => (item={'vrf_name': 'VRF_OVERLAY_2020', 'vrf_core_vlan_id': 2020, 'vrf_l3_vni_id': 20020, 'vrf_edge_vlan': [{'id': 40, 'ip': '10.40.40.2', 'mask': '255.255.255.0'}, {'id': 50, 'ip': '10.50.50.2', 'mask': '255.255.255.0'}]})
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3_loop/1/playbook_clear_all_config_inner_loop.yml for sw-access-leaf-2 => (item={'vrf_name': 'VRF_OVERLAY_2030', 'vrf_core_vlan_id': 2030, 'vrf_l3_vni_id': 20030, 'vrf_edge_vlan': [{'id': 60, 'ip': '10.60.60.2', 'mask': '255.255.255.0'}]})
