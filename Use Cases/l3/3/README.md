# LAYER3 (L3) USE CASE #3

##

### Playbook details:
This playbook covers the L3 USE CASE #3 with this configuration:
  * **DHCP Relay**: Global
  ...
  * This playbook validates this data post-execution:
    ...
    * **Playbook tasks validation example**:
      * Succesfull execution (note 0 task failed):
        ```SHELL
        PLAY RECAP *******************************************************************************************
        sw-access-leaf-1           : ok=45   changed=12   unreachable=0    failed=0    skipped=6    rescued=0    ignored=0
        sw-access-leaf-2           : ok=49   changed=13   unreachable=0    failed=0    skipped=5    rescued=0    ignored=0
...
### Main playbook execution example:
  ...
  * **The main playbook execution should look like this**:
    ...
    ok: [sw-access-leaf-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-1_config.2022-02-16@12:54:33",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-1_config.2022-02-16@12:54:33",
    ...
    ok: [sw-access-leaf-2] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-2_config.2022-02-16@12:54:33",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-2_config.2022-02-16@12:54:33",
    ...
    ok: [sw-core-spine-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-core-spine-1_config.2022-02-16@12:54:33",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-core-spine-1_config.2022-02-16@12:54:33",
    ...
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/leaf_core_vrf_ipv4_multicast_config.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/multicast_config_global.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/leaf_core_vlan_ipv4_multicast_config.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/l3_edge_vlan_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/dhcp_config.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/nve_interface.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/bgp_config_ipv4_multicast_config.yml for sw-access-leaf-1, sw-access-leaf-2

    TASK [layer_3 : CONFIG BGP IPV4 + MULTICAST LEAF] ****************************************************
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/leaf_border_handoff_multicast_config.yml for sw-access-leaf-2

    TASK [layer_3 : CONFIG BGP IPV4 LEAF BORDER HANDOFF] *************************************************
    changed: [sw-access-leaf-2] => (item=sw-core-spine-1)
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-access-leaf-2]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/layer_3/tasks/use_case_3/spine_bgp_ipv4_core.yml for sw-core-spine-1
    ...
    ok: [sw-access-leaf-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-1_config.2022-02-16@12:55:40",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-1_config.2022-02-16@12:55:40",
                "shortname": "./backup/sw-access-leaf-1_config",
                "time": "12:55:40"
            }
        ]
    ...
    ok: [sw-core-spine-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-core-spine-1_config.2022-02-16@12:55:40",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-core-spine-1_config.2022-02-16@12:55:40",
                "shortname": "./backup/sw-core-spine-1_config",
                "time": "12:55:40"
            }
        ]
    ...
    ok: [sw-access-leaf-2] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-2_config.2022-02-16@12:55:40",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-2_config.2022-02-16@12:55:40",
                "shortname": "./backup/sw-access-leaf-2_config",
                "time": "12:55:40"
            }
        ]
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-access-leaf-2]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/3/roles/common/tasks/verification_bgp.yml for sw-core-spine-1
...
### Utility playbook execution example:
  ...
  * **The utility playbook execution should look like this**:
    ...
    TASK [CLEAR CONFIG BGP IPV4 LEAF BORDER HANDOFF] *****************************************************
    changed: [sw-access-leaf-2]
    changed: [sw-core-spine-1]
    changed: [sw-access-leaf-1]

    TASK [CLEAR CONFIG BGP IPV4 + MULTICAST LEAF] ********************************************************
    changed: [sw-access-leaf-2]
    changed: [sw-core-spine-1]
    changed: [sw-access-leaf-1]
