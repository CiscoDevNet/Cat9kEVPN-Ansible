# DISTRIBUTED ANYCAST GATEWAY (DAG) USE CASE #4
...
### Per node variables for _leafs_ nodes:
  ...
  * **Example**: two leaf nodes, one simple "leaf", one "border" leaf:
    ...
    ```
      ...
      * Note that common variables like like **ip_mask**, **dag_ipv4_mask**, **ipv6_prefix** and **dag_ipv6_prefix** can be removed from the individual nodes and moved to the "vars" section of the group.
