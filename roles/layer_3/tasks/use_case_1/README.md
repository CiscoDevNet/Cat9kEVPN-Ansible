# LAYER3 (L3) USE CASE #1

##

### Playbook details:
This playbook covers the L3 USE CASE #1 with this configuration:
  * **DHCP Relay**: Global
...
### Per node variables for _leafs_ nodes:
  ...
  * **Example**: two leaf nodes, one simple "leaf", one "border" leaf:
    ...
    ```
      ...
      * Note that common variables like **ip_mask** can be removed from the individual nodes and moved to the "vars" section of the group.
...
### Group variables for "network" group (whole network, all nodes):
  ...
  * **Example**: "network" group, conformed by _leafs_ and _spines_ groups as "children" plus all the variables needed by this group under the section "vars":
    ...
    ```
     * Note the indentation for YAML (two spaces).
     * Note that common variables like **ip_mask** can be removed from the individual nodes and moved to the "vars" section for the whole network under the group "network", as long as the value of this variables is the same.
  ...
  * This playbook validates this data post-execution:
    ...
    * **Playbook tasks validation example**:
      * Succesfull execution (note 0 task failed):
        ```SHELL
        PLAY RECAP *******************************************************************************************
        sw-access-leaf-1           : ok=41   changed=11   unreachable=0    failed=0    skipped=6    rescued=0    ignored=0
        sw-access-leaf-2           : ok=45   changed=12   unreachable=0    failed=0    skipped=5    rescued=0    ignored=0
...
### Inventory example:
  * A full inventory, three leafs, two simple leafs, one border leaf and two spines, with all the needed variables looks like this:
    ...
    ```
      * Note the indentation for YAML (two spaces).
      * Note that common variables like **ip_mask** can be removed from the individual nodes and moved to the "vars" section of the group or to the "vars" section for the whole network under the group "network", as long as the value of this variables is the same.
...
### Utility playbook execution (configuration cleanup):
  ...
  * **Playbook execution example**:
    * Succesfull execution (note 0 task failed):
      ```SHELL
      PLAY RECAP *******************************************************************************************
      sw-access-leaf-1           : ok=10   changed=9    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
      sw-access-leaf-2           : ok=10   changed=9    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
      sw-core-spine-1            : ok=10   changed=6    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
      ```
    * Failed execution (note 1 task failed on sw-access-leaf-1):
      ```SHELL
      PLAY RECAP *******************************************************************************************
      sw-access-leaf-1           : ok=9   changed=9    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0
      sw-access-leaf-2           : ok=10   changed=9    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
      sw-core-spine-1            : ok=10   changed=6    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
      ```
...
### Main playbook execution example:
  ...
  * **The main playbook execution should look like this**:
    ...
    ok: [sw-core-spine-1] => (item={'commands': ['ping 10.255.255.253 repeat 1000 source 10.255.255.254'], 'packet_loss': '0%', 'packets_rx': 1000, 'packets_tx': 1000, 'rtt': {'min': 1, 'avg': 1, 'max': 2}, 'invocation': {'module_args': {'dest': '10.255.255.253', 'source': '10.255.255.254', 'count': 1000, 'state': 'present', 'df_bit': False, 'size': None, 'vrf': None, 'provider': None}}, 'failed': False, 'changed': False, 'item': 'sw-access-leaf-1', 'ansible_loop_var': 'item'}) => {
        "ansible_loop_var": "item",
        "changed": false,
        "item": {
            "ansible_loop_var": "item",
    ...
    ok: [sw-access-leaf-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-1_config.2022-02-16@11:09:39",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-1_config.2022-02-16@11:09:39",
    ...
    ok: [sw-core-spine-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-core-spine-1_config.2022-02-16@11:09:39",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-core-spine-1_config.2022-02-16@11:09:39",
    ...
    ok: [sw-access-leaf-2] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-2_config.2022-02-16@11:09:39",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-2_config.2022-02-16@11:09:39",
    ...
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/leaf_core_vrf_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2

    TASK [layer_3 : CONFIG VRF IPV4] *********************************************************************
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/leaf_core_vlan_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/l3_edge_vlan_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/dhcp_config.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/nve_interface.yml for sw-access-leaf-1, sw-access-leaf-2
    ...
    TASK [layer_3 : include_tasks] ***********************************************************************
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/bgp_config_ipv4.yml for sw-access-leaf-1, sw-access-leaf-2

    TASK [layer_3 : CONFIG BGP IPV4 LEAF] ****************************************************************
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-core-spine-1]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/leaf_border_handoff.yml for sw-access-leaf-2
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-access-leaf-2]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/layer_3/tasks/use_case_1/spine_bgp_ipv4_core.yml for sw-core-spine-1
    ...
    ok: [sw-access-leaf-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-1_config.2022-02-16@11:10:40",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-1_config.2022-02-16@11:10:40",
                "shortname": "./backup/sw-access-leaf-1_config",
                "time": "11:10:40"
            }
        ]
    ...
    ok: [sw-access-leaf-2] => {
        "msg": [
            {
                "backup_path": "./backup/sw-access-leaf-2_config.2022-02-16@11:10:40",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-access-leaf-2_config.2022-02-16@11:10:40",
                "shortname": "./backup/sw-access-leaf-2_config",
                "time": "11:10:40"
            }
        ]
    ...
    ok: [sw-core-spine-1] => {
        "msg": [
            {
                "backup_path": "./backup/sw-core-spine-1_config.2022-02-16@11:10:40",
                "changed": true,
                "date": "2022-02-16",
                "failed": false,
                "filename": "sw-core-spine-1_config.2022-02-16@11:10:40",
                "shortname": "./backup/sw-core-spine-1_config",
                "time": "11:10:40"
            }
        ]
    ...
    skipping: [sw-access-leaf-1]
    skipping: [sw-access-leaf-2]
    included: /home/netadmin/ansible/bgp-evpn-ansible/use_cases/l3/1/roles/common/tasks/verification_bgp.yml for sw-core-spine-1
...
### Utility playbook execution example:
  ...
  * **The utility playbook execution should look like this**:
    ...
    TASK [CLEAR CONFIG L3_EDGE_VLAN_IPV4 1] **************************************************************
    ok: [sw-core-spine-1]
    changed: [sw-access-leaf-2]
    changed: [sw-access-leaf-1]

    TASK [CLEAR CONFIG L3_EDGE_VLAN_IPV4 2] **************************************************************
    changed: [sw-access-leaf-2]
    changed: [sw-access-leaf-1]
    changed: [sw-core-spine-1]
